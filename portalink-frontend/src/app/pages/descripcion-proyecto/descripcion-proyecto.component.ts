  ...
  template: `
    <div class="min-h-screen w-full flex flex-col font-sans page-wrapper project-detail-wrapper">
      ...
      <main class="flex-grow w-full pt-24 md:pt-28 pb-20 relative z-10" *ngIf="project">
        ...
        <!-- Main Interactive Media Showcase (Gallery & Carousel) -->
        <section class="max-w-[1400px] mx-auto px-6 sm:px-10 mb-16">
          <div class="main-image-container relative rounded-[28px] sm:rounded-[36px] overflow-hidden border shadow-2xl group">
            ...
            <div class="absolute bottom-6 right-6 backdrop-blur-md bg-black/60 border border-white/10 px-4 py-2 rounded-xl text-white text-xs font-mono">
              Visualización HD 1080p
            </div>
          </div>

          <!-- Thumbnail Gallery Switcher -->
          <div class="flex items-center gap-4 mt-6 overflow-x-auto pb-2 no-scrollbar" *ngIf="project.images.length > 1">
            <button *ngFor="let img of project.images; let i = index"
                    (click)="activeImage = img"
                    class="relative flex-shrink-0 w-32 sm:w-40 aspect-[16/10] rounded-xl overflow-hidden border transition-all duration-300"
                    [class.border-[var(--accent-color,#00f5ff)]]="activeImage === img"
                    [class.scale-105]="activeImage === img"
                    [class.opacity-50]="activeImage !== img">
              <img [src]="img" [alt]="'Screenshot ' + i" class="w-full h-full object-cover object-top">
            </button>
          </div>
        </section>
        ...
        <section class="max-w-[1400px] mx-auto px-6 sm:px-10 mb-16">
          <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <div *ngFor="let stat of project.stats" class="p-6 rounded-2xl border stat-card text-center">
              <div class="text-3xl sm:text-4xl font-headline font-black text-[var(--accent-color,#00f5ff)] mb-1">
                {{ stat.value }}
              </div>
              <div class="text-xs uppercase tracking-wider font-mono text-muted">
                {{ stat.label }}
              </div>
            </div>
          </div>
        ...
        <section class="max-w-[1400px] mx-auto px-6 sm:px-10 mb-12">
          <div class="p-8 sm:p-12 rounded-3xl border cta-banner relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div class="flex items-center gap-4 flex-wrap flex-shrink-0">
              ...
              <a [href]="project.liveUrl" target="_blank" rel="noopener noreferrer"
                 class="px-6 py-4 rounded-xl border font-bold text-xs uppercase tracking-widest hover:bg-white/10 transition-all">
                Ver Sitio Web ↗
              </a>
            </div>
          </div>
  ...
  projectsData: ProjectDetail[] = [
    {
      ...
      year: '2026',
      liveUrl: 'https://camascotas.portalink.co',
...
El proyecto destaca por su arquitectura ágil, catálogo dinámico de productos, personalizador interactivo en tiempo real y una integración fluida con WhatsApp para cerrar ventas de forma directa e inmediata.
...
Incluye además un completo panel administrativo donde la marca puede gestionar categorías, promociones, inventario y métricas de pedidos en tiempo real.`,
      highlights: [
        'Catálogo interactivo con filtrado dinámico por tamaño y material',
        'Personalizador visual para selección de tonos de tela y acabados',
      ...
      features: [
        {
          icon: 'M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 0a2 2 0 100 4 2 2 0 000-4z',
          title: 'Carrito en Tiempo Real',
          desc: 'Gestión fluida de productos elegidos, cálculo de cantidades y opciones de despacho.'
        },
        {
          icon: 'M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4',
          title: 'Personalizador de Producto',
          desc: 'Los clientes seleccionan acabados, tipos de madera y grabado personalizado.'
        },
        {
      ...
      rotbotPrompt: 'Hola, quiero una tienda E-commerce como CAMASCOTAS con catálogo, carrito y panel de administración.'
    },
    {
      id: 'sysmicon',
      code: 'SYS_02',
      ...
      year: '2026',
      liveUrl: 'https://sysmicon.portalink.co',
...
Integra una suite de herramientas avanzadas: visualización interactiva de planos CAD en 2D/3D, seguimiento de etapas de obra, módulo de cotizaciones ejecutivas y una galería inmersiva de proyectos habitacionales.`,
    ...
    },
    {
      ...
      year: '2026',
      liveUrl: 'https://catalogo.portalink.co',
      ...
      longDescription: `CATÁLOGO DIGITAL es un ecosistema inteligente concebido para empresas con amplios volúmenes de productos y múltiples líneas de negocio.
...
Integra modelos de Inteligencia Artificial (Groq / Llama 3) para automatizar la generación de descripciones técnicas, detectar productos sin fotografía o información incompleta y emitir reportes de inventario en tiempo real.`,
    ...
    },
    {
      ...
      tagline: 'Tienda de colchones y descanso premium con catálogo HD y atención personalizada.',
      category: 'E-commerce & Retail',
      client: 'Districol Armenia',
      year: '2026',
      liveUrl: 'https://districol.portalink.co',
...
Diseñada con un estándar visual premium, ofrece fichas fisiológicas de producto con nivel de firmeza, composición de espuma/resortes y asesoría personalizada inmediata por WhatsApp.`,
      highlights: [
        'Catálogo en alta definición con comparador de firmeza y materiales',
...
Conectado a la base de datos empresarial, este copiloto comprende instrucciones en lenguaje natural, redacta informes, calcula ticket promedio, proyecta metas de ventas y aconseja acciones comerciales para optimizar inventarios.`,
    ...
    },
    {
      ...
      year: '2026',
      liveUrl: 'https://tiendaintima.portalink.co',
...
Ofrece un catálogo refinado con recomendador inteligente de tallas y combinaciones, carrito ultrarrápido y un panel administrativo completo para monitorear tendencias de compra e inventario en vivo.`,
  ...
  loadProject(id: string) {
    ...
    if (found) {
      this.project = found;
      this.activeImage = found.image;
    } else {
      // Default fallback
      this.project = this.projectsData[0];
      this.activeImage = this.projectsData[0].image;
    }
  }
