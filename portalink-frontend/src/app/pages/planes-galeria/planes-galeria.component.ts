            ...
            <div class="px-6 py-5 bg-white/[0.02] border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 flex-shrink-0">
              ...
              <div class="flex items-center gap-3 w-full sm:w-auto flex-wrap">
                ...
                <a [routerLink]="['/proyecto', previewModalProject.id]" (click)="closePreview()"
                   class="px-6 py-3 rounded-xl bg-white text-black font-extrabold text-xs uppercase tracking-widest hover:scale-105 transition-all cursor-pointer w-full sm:w-auto text-center shadow-md flex items-center justify-center gap-1.5">
