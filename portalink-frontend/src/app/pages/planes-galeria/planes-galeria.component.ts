  ...
  template: `
    <div class="h-screen w-full flex flex-col overflow-hidden font-sans page-wrapper">
      <div class="flex-grow w-full pt-20 overflow-y-auto custom-scrollbar relative">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 pt-8 pb-24 relative z-10">
          
          <!-- Botón Volver a Planes -->
          <div class="mb-8">
            <a routerLink="/planes" 
               class="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 text-xs font-bold uppercase tracking-widest text-white/80 hover:text-white transition-all cursor-pointer">
          ...
          <div class="text-center max-w-3xl mx-auto mb-12">
            ...
            <h1 class="text-3xl sm:text-5xl font-headline uppercase tracking-tight text-white leading-tight">
