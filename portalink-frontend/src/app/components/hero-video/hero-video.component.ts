          ...
          <div class="relative w-full rounded-[20px] sm:rounded-[36px] overflow-hidden transition-all duration-700 border shadow-md"
               [ngClass]="currentTheme === 'light' 
                 ...
                 : 'bg-neutral-900 border-neutral-800 shadow-[0_20px_50px_rgba(0,0,0,0.6)]'">
                        <!-- Mobile Video Element (portalink-movil.mp4 optimizado 720p 30fps) -->
              <video #mobileHeroVideo
                ...
                <source src="https://res.cloudinary.com/doxdjiyvi/video/upload/w_720,fps_30,q_auto/v1786974908/portalink-movil_thu5si.mp4" type="video/mp4">
              </video>

              <!-- Desktop Video Element (portalink.mp4 optimizado 1280p 30fps) -->
              <video #heroVideo
                     ...
                     preload="auto"
                     (ended)="onVideoEnded()">
                <source src="https://res.cloudinary.com/doxdjiyvi/video/upload/w_1280,fps_30,q_auto/v1786974918/portalink_vat2xb.mp4" type="video/mp4">
              </video>
          </div>
