          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-20">
            ...
            <div>
              <div class="flex items-center gap-4 mb-4">
                ...
                <span class="text-xs uppercase tracking-[0.4em]" style="color: var(--text-secondary);">Connect</span>
              </div>
              <h2 class="text-5xl md:text-7xl mb-12" style="color: var(--text-primary);">Let's build <br/><span style="color: var(--text-primary);">something great.</span></h2>
              
              <div class="space-y-8">
                <div>
                  <span class="text-[10px] uppercase tracking-widest block mb-2" style="color: var(--text-secondary); opacity: 0.7;">Email me</span>
            ...
            <form class="space-y-10" *ngIf="data?.formActive !== false">
              <div class="relative group">
                ...
                <label class="absolute left-0 top-4 uppercase tracking-widest text-xs pointer-events-none transition-all peer-focus:-top-4 peer-focus:text-[10px] peer-[:not(:placeholder-shown)]:-top-4 peer-[:not(:placeholder-shown)]:text-[10px]" style="color: var(--text-secondary);">Name</label>
              </div>
              ...
              <div class="relative group">
                ...
                <label class="absolute left-0 top-4 uppercase tracking-widest text-xs pointer-events-none transition-all peer-focus:-top-4 peer-focus:text-[10px] peer-[:not(:placeholder-shown)]:-top-4 peer-[:not(:placeholder-shown)]:text-[10px]" style="color: var(--text-secondary);">Email</label>
              </div>
              ...
              <div class="relative group">
                ...
                <label class="absolute left-0 top-4 uppercase tracking-widest text-xs pointer-events-none transition-all peer-focus:-top-4 peer-focus:text-[10px] peer-[:not(:placeholder-shown)]:-top-4 peer-[:not(:placeholder-shown)]:text-[10px]" style="color: var(--text-secondary);">Message</label>
              </div>
            ...
            <div *ngIf="data?.formActive === false" class="flex items-center justify-center border p-10" style="border-color: var(--card-border); background: var(--card-bg);">
              <p class="text-center italic text-sm" style="color: var(--text-secondary);">El formulario de contacto está temporalmente desactivado. Por favor, usa el email directo.</p>
            </div>
          </div>
        </div>
      </div>
